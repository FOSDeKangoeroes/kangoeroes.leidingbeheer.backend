...
namespace kangoeroes.infrastructure.Migrations
{
    ...
    [Migration("20191111093818_ChangeAccountTables")]
    partial class ChangeAccountTables
    {
            ...
            modelBuilder.Entity("kangoeroes.core.Models.Leiding", b =>
                {
                    b.HasOne("kangoeroes.core.Models.Accounting.Account", "DebtAccount")
                        .WithOne()
                        .HasForeignKey("kangoeroes.core.Models.Leiding", "DebtAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("kangoeroes.core.Models.Accounting.Account", "TabAccount")
                        .WithOne()
                        .HasForeignKey("kangoeroes.core.Models.Leiding", "TabAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
